    ...
    <div class="row">
            ...
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @foreach ($product->suppliers as $supplier)
                        <button onclick="showProModal(this)" class="dropdown-item"
                            data-pro="{{ $supplier->code_supplier }}" data-toggle="modal" data-target="#prodModal">
                            {{ $supplier->name }}
                        </button>
                    @endforeach
                </div>
            ...
            <ul class="list-group mb-3">
                @if ($product->photo)
                    <li class="list-group-item p-0 overflow-hidden">
                        <div>
                            <img id="photo" class="w-100 mx-auto p-0" alt="{{ $product->photo }}"
                                src="{{ $product->photo }}">
                        </div>
                    </li>
                @endif
        ...
        <div class="col p-0">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#addModal"><i
                        class="fa fa-plus"></i> Ajouter un fournisseur</button>
            </h4>
            <form id="update" method="post"
                action="{{ route('admin.products.update', ['product' => $product->code_product]) }}">
                <div class="row">
                        ...
                        <div class="col form-group">
                            ...
                            <select class="form-control" name="code_category" id="code_category">
                                @foreach ($categories as $category)
                                    <option @if ($category->code_category == $product->code_category) selected @endif value="{{ $category->code_category }}">
...
<div id="prodModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                ...
                <div class="d-flex justify-content-center">
                    <div class="row">
                        ...
                        <div class="col-md-5 form-group">
                            ...
                            <input type="number" id="prodPrixProduction" step="0.01" min="0" class="form-control"
...
<div class="modal fade" id="addModal" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body py-0">
                <div class="col p-0">
                    ...
                    <form id="addpro"
                        action="{{ route('products.suppliers.create', ['product' => $product->code_product]) }}"
                        method="post" class="px-2 pt-4">
                        <div class="d-flex justify-content-center">
                            <div class="row">
                                <div class="col-md-7 form-group">
                                    ...
                                    <select class="form-control" name="code_supplier" id="code_supplier">
                                        ...
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier->code_supplier }}">{{ $supplier->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
...
<script>
    function showProModal(e) {
        var product = JSON.parse('@json($product->with('suppliers'))')
